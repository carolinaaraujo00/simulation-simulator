...
class ociffer(ShowBase):
    ...
    def setup_desk_lamp(self):
        ...
        setup_torch_spotlight(self.render, (-1.5, -0.21, 3), (-1.7, -0.68, 0))
    ...
    def setup_giant_orange(self):
        print("orange")
        # orange_location = Vec3(-2.5, 2.43, 4)
        orange_location = Vec3(0, 0, 0)
        # self.orange = self.loader.loadModel(orange_model_path)
        self.orange = self.loader.loadModel(printer_model_path)
        self.orange.setScale(1)
